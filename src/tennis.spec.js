...
describe("Tennis",()=>{
    ...
    it("deberia mostrar 40-30 cuando jugador 1 anoto 3 puntos y jugador 2 anoto 2 puntos",()=>{
        let tennis = new Tennis();
        tennis.jugador1 = 3;
        tennis.jugador2 = 2;
    ...
    it("deberia mostrar  cuando jugador 1 anoto 2 puntos y jugador 2 anoto 3 puntos",()=>{
        ...
        tennis.jugador1 = 2;
        tennis.jugador2 = 3;
        expect(tennis.obtenerScore()).toBe("30 - 40");
    });
    it("deberia mostrar deuce cuando jugador 1 anoto 3 puntos y jugador 2 anoto 3 puntos",()=>{
        let tennis = new Tennis();
        tennis.jugador1 = 3;
        tennis.jugador2 = 3;
        expect(tennis.obtenerScore()).toBe("Deuce");
    });
    it("deberia mostrar Advantage Player 1 cuando jugador 1 anoto 4 puntos y jugador 2 anoto 3 puntos",()=>{
        let tennis = new Tennis();
        tennis.jugador1 = 4;
        tennis.jugador2 = 3;
        expect(tennis.obtenerScore()).toBe("Advantage Player 1");
    });
    it("deberia mostrar Advantage Player 2 cuando jugador 1 anoto 3 puntos y jugador 2 anoto 4 puntos",()=>{
        let tennis = new Tennis();
        tennis.jugador1 = 3;
        tennis.jugador2 = 4;
